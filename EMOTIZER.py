...
#emotion_model_path = 'models/Model-2.h5'
...
parser.add_argument('-m', '--trained_model', default='weights/Final_Face_ep50_lr-6.pth',
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        frames = "frames = {:}".format(n)
        cv2.putText(img_raw, frames, (10, 400),
                    cv2.FONT_HERSHEY_DUPLEX, 0.5, (255, 255, 255))
        ...
        for b in dets:
            ...
            if roi.shape[0]!=0 and roi.shape[1]!=0:
                ...
                #roi_rec = cv2.resize(roi_rec, (48, 48), cv2.INTER_LINEAR)
            ...
            #for nf in range(10):
                    ...
                    #video_name_roi = str(time.strftime("%Y_%m_%d_%H_%M")) + '_roi_.avi'
                    #vout_roi = cv2.VideoWriter(video_name_roi,cv2.VideoWriter_fourcc('M','J','P','G'), 20,(48,48))
      
                    #vout_roi.write(roi_rec) 
            ...
            for (i, (emotion, prob)) in enumerate(zip(EMOTIONS, preds)):
                ...
                #cv2.rectangle(img_raw, (fX, fY), (fW, fH),colorbb, 1)
                #cv2.rectangle(img_raw, (fX, fY), (fW, fY-30),colorbb, -1)
                #cv2.putText(img_raw, label, (fX + 5, fY - 10),
                #cv2.FONT_HERSHEY_SIMPLEX, 0.45, (255, 255, 255), 2)
                ...
                cv2.rectangle(img_raw, (fX, fY), (fW, fY-int(30*ratio)),colorbb, -1)


                cv2.putText(img_raw, label, (fX + 5, fY - 7),
                cv2.FONT_HERSHEY_DUPLEX, 0.6*ratio, (255, 255, 255))
